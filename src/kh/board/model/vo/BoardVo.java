 ...
 */
	...
	private String boardOrigialFilename;
	...
	public String getBoardOrigialFilename() {
		return boardOrigialFilename;
	}
	public void setBoardOrigialFilename(String boardOrigialFilename) {
		this.boardOrigialFilename = boardOrigialFilename;
	}
	...
	public String toString() {
		return "BoardVo [boardNum=" + boardNum + ", boardTitle=" + boardTitle + ", boardWriter=" + boardWriter
				+ ", boardContent=" + boardContent + ", boardOrigialFilename=" + boardOrigialFilename
	...
	public BoardVo(int boardNum, String boardTitle, String boardWriter, String boardContent,
			String boardOrigialFilename, String boardRenameFilename, Date boardDate, int boardLevel, int boardRef,
